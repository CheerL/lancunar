...
if __name__ == '__main__':
    ...
    params['ModelParams']['dirValidation'] = 'data/Lancunar/mini_val/' # the directory of training data
    ...
    params['ModelParams']['batchsize'] = 24  # the batch size
    params['ModelParams']['iteration'] = 1000000
    params['ModelParams']['baseLR'] = 1e-3  # the learning rate, initial one
    ...
    params['ModelParams']['loss'] = 'dice'
    # params of the DataManager
    params['DataManagerParams']['epoch'] = 5000  # the number of total training iterations
    params['DataManagerParams']['nProc'] = 2  # the number of threads to do data augmentation
    ...
    params['DataManagerParams']['MaxEmpty'] = 3
    ...
    if len(train) > 0:
        ...
        dataManagerTrain.run_feed_processes()
        # thread creation
        model.train(dataManagerTrain) #train model
        # for iteration in range(10000):
        #     a, b = dataManagerTrain.data_queue.get()
        #     if not iteration % 100:
        #         print(iteration, dataManagerTrain.data_queue.qsize())
        #         time.sleep(1)
